...
# Unit tests for KoronaClient::PaymentMethodsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaymentMethodsApi' do
  before do
    # run before each test
    @instance = KoronaClient::PaymentMethodsApi.new
  end
  ...
  describe 'test an instance of PaymentMethodsApi' do
    it 'should create an instance of PaymentMethodsApi' do
      expect(@instance).to be_instance_of(KoronaClient::PaymentMethodsApi)
    end
  end
