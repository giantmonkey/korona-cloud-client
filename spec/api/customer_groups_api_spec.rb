...
# Unit tests for KoronaClient::CustomerGroupsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CustomerGroupsApi' do
  before do
    # run before each test
    @instance = KoronaClient::CustomerGroupsApi.new
  end
  ...
  describe 'test an instance of CustomerGroupsApi' do
    it 'should create an instance of CustomerGroupsApi' do
      expect(@instance).to be_instance_of(KoronaClient::CustomerGroupsApi)
    end
  end
