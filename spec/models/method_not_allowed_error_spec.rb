...
# Unit tests for KoronaClient::MethodNotAllowedError
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MethodNotAllowedError' do
  before do
    # run before each test
    @instance = KoronaClient::MethodNotAllowedError.new
  end
  ...
  describe 'test an instance of MethodNotAllowedError' do
    it 'should create an instance of MethodNotAllowedError' do
      expect(@instance).to be_instance_of(KoronaClient::MethodNotAllowedError)
    end
  end
