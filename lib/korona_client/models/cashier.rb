...
module KoronaClient
  ...
  class Cashier
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'loginCode')
        self.login_code = attributes[:'loginCode']
      end

      if attributes.has_key?(:'loginPassword')
        self.login_password = attributes[:'loginPassword']
      end
    ...
    def hash
      [active, id, number, revision, _alias, email, firstname, gender, login_code, login_password, permissions, role, surname].hash
    end
