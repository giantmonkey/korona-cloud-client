...
module KoronaClient
  ...
  class Currency
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'centName')
        self.cent_name = attributes[:'centName']
      end
      ...
      if attributes.has_key?(:'denominations')
        if (value = attributes[:'denominations']).is_a?(Array)
          self.denominations = value
        end
      end

      if attributes.has_key?(:'exchangeRates')
        if (value = attributes[:'exchangeRates']).is_a?(Array)
      ...
      if attributes.has_key?(:'systemCurrency')
        self.system_currency = attributes[:'systemCurrency']
      end
