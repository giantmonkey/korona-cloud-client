...
module KoronaClient
  ...
  class OrganizationalUnit
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'parentOrganizationalUnit')
        self.parent_organizational_unit = attributes[:'parentOrganizationalUnit']
      end
    ...
    def hash
      [active, id, number, revision, address, economic_zone, name, parent_organizational_unit, price_group, warehouse].hash
    end
