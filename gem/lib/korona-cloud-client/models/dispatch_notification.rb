...
module KoronaCloudClient
  class DispatchNotification
    ...
    def hash
      [active, id, number, revision, delivery_date, shipping_date, point_of_sale, create_time, booking_time, booking_user, booking_api_user, cashier, create_user, customer, description, items_count, organizational_unit, party_information, product_stock_order, source_organizational_unit, supplier, comment].hash
    end
