...
module KoronaCloudClient
  class FiscalUnit
    ...
    def hash
      [active, id, number, revision, admin_pin, admin_puk, certificate, log_time_format, name, process_data_encoding, public_key, signature_algorithm, state, time_admin_pin, type, api_key, api_secret, remote_url, tss_client_uid].hash
    end
