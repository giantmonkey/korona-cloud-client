...
module KoronaCloudClient
  class InventoryList
    ...
    def hash
      [active, id, number, revision, booking_time, booking_user, booking_api_user, cashier, create_time, description, finish_time, inventory, modified_time, organizational_unit, point_of_sale, status].hash
    end
