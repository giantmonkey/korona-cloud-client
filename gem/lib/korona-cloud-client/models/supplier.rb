...
module KoronaCloudClient
  class Supplier
    ...
    def self.openapi_types
      {
        ...
        :'address' => :'ProductTransferInvolvedPartyInformationData',
    ...
    def hash
      [active, id, revision, number, additional_information, address, contact, contact_person, customer_number, name, payment, return_address, delivery_conditions].hash
    end
