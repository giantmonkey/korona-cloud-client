...
module KoronaCloudClient
  class PosButtonFunction
    ...
    def valid?
      ...
      internal_system_call_type_validator = EnumAttributeValidator.new('String', ["MESSAGE", "STOCK", "CUSTOMER", "CASHIER", "DAY_RATING", "BONUS_POINTS", "RESOLVE_UNKNOWN_PRODUCTS", "EVENTS", "EVENTS_VALIDATION"])
    ...
    def internal_system_call_type=(internal_system_call_type)
      validator = EnumAttributeValidator.new('String', ["MESSAGE", "STOCK", "CUSTOMER", "CASHIER", "DAY_RATING", "BONUS_POINTS", "RESOLVE_UNKNOWN_PRODUCTS", "EVENTS", "EVENTS_VALIDATION"])
