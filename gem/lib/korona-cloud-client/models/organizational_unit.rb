...
module KoronaCloudClient
  class OrganizationalUnit
    ...
    def hash
      [active, id, number, revision, address, cost_center, economic_zone, eh_number, identification, name, opening_hours, parent_organizational_unit, price_group, warehouse].hash
    end
