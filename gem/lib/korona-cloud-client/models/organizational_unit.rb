...
module KoronaCloudClient
  class OrganizationalUnit
    ...
    def hash
      [active, id, revision, number, address, cost_center, economic_zone, eh_number, identification, name, opening_hours, parent_organizational_unit, price_group, warehouse, org_from_order].hash
    end
