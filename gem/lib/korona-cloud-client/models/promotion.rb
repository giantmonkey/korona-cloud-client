...
module KoronaCloudClient
  class Promotion
    ...
    def valid?
      type_validator = EnumAttributeValidator.new('String', ["BONUSPOINTS_CASHIER", "BONUSPOINTS_CUSTOMER", "COUPON_DISCOUNT", "IMMEDIATE_DISCOUNT", "STAMPS"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["BONUSPOINTS_CASHIER", "BONUSPOINTS_CUSTOMER", "COUPON_DISCOUNT", "IMMEDIATE_DISCOUNT", "STAMPS"])
    ...
    def hash
      [active, id, number, revision, benefit, bonuspoint, coupon, deactivated, name, receipt_info_texts, stamp, triggers, type, validity, number_length].hash
    end
