...
module KoronaCloudClient
  ...
  class PosBalance
    ...
    def hash
      [active, id, revision, number, balance_attempts, cashier, create_time, finish_time, summaries, summary_changesets, items, total, transaction_receipt_code, z_count].hash
    end
