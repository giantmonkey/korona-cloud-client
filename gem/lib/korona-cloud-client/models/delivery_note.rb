...
module KoronaCloudClient
  class DeliveryNote
    ...
    def hash
      [active, id, revision, number, booking_time, cashier, comment, customer, delivery_time, finalized, items, order_number, organizational_unit, point_of_sale, signature, total].hash
    end
