...
module KoronaCloudClient
  class ReceiptItem
    ...
    def hash
      [attendance, booking_time, commodity_group, description, discounts, id, indent, index, info_texts, manual_price, product, quantity, sector, serial_numbers, total, delivery_date, external_references, recognition_number, type, voucher_transaction, special_price_configuration].hash
    end
