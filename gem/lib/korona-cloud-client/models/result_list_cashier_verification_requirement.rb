...
module KoronaCloudClient
  class ResultListCashierVerificationRequirement
    ...
    def list_invalid_properties
      ...
      if @max_revision.nil?
        invalid_properties.push('invalid value for "max_revision", max_revision cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @max_revision.nil?
      true
    end
    ...
    def hash
      [current_page, links, pages_total, results, results_of_page, results_total, max_revision].hash
    end
