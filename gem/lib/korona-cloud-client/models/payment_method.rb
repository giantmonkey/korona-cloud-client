...
module KoronaCloudClient
  class PaymentMethod
    ...
    def hash
      [active, id, number, revision, allowed_balance_difference, currency, force_customer_number, force_print, name, payment_service, print_copies, tag, use_cash_drawer, revenue_account, attach_payment_terminal_data_to_receipt, max_payment_sum].hash
    end
