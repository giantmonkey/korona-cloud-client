...
module KoronaCloudClient
  class StoreOrder
    ...
    def hash
      [active, id, revision, number, create_time, process_time, finish_time, point_of_sale, target_organizational_unit, comment, items_count, customer_order, pickup_date].hash
    end
