...
module KoronaCloudClient
  class AdditionalReceiptInfoType
    ...
    def hash
      [active, id, revision, number, cashier_input_required, customer_groups, description, min_item_quantity, min_total, options, organizational_units, required, tag, validity].hash
    end
