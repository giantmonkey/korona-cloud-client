...
module KoronaCloudClient
  ...
  class Receipt
    ...
    def hash
      [active, id, revision, number, account_transactions, additional_info, booking_time, cancelled, cashier, creation_time, currency, reversed_receipt, customer, customer_group, deposit_amount, external_references, reversal, fiscal_transactions, geo_location, info_texts, items, max_revisions, order_number, organizational_unit, payments, cashier_verification_results, point_of_sale, price_group, revenue, signature, total, voided, voided_items, void_fiscal_transactions, voucher_transactions, voucher_transaction_references, warehouse, zcounter, promotion_applications, coupon_positions, digital_receipt_info].hash
    end
