...
module KoronaCloudClient
  class CustomerDisplayConfiguration
    ...
    def hash
      [active, id, revision, number, font_scale, name, booking_url, booking_image, booking_image_id, closed_url, closed_text, closed_image, closed_image_id, welcome_text, welcome_url, welcome_image, welcome_image_id, graphical_display, layout_type, theme_color].hash
    end
