...
module KoronaCloudClient
  class Cashier
    ...
    def hash
      [active, id, number, revision, _alias, deactivated, email, firstname, surname, gender, login_code, login_password, permissions, role, bonus_points, background_color, organizational_units, cashier_role, create_time, last_receipt_time, number_length].hash
    end
