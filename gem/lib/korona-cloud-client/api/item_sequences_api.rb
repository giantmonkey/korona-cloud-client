...
module KoronaCloudClient
  class ItemSequencesApi
    ...
    # @param body [Array<ItemSequence>] array of new item sequences
    # @param [Hash] opts the optional parameters
    # @option opts [Boolean] :upsert when set to true, updates the object instead of generating a already-exists-error
    # @return [Array<AddOrUpdateResult>]
    def add_item_sequences(korona_account_id, body, opts = {})
      data, _status_code, _headers = add_item_sequences_with_http_info(korona_account_id, body, opts)
      data
    end
    ...
    def add_item_sequences_with_http_info(korona_account_id, body, opts = {})
      ...
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ItemSequencesApi.add_item_sequences"
      end
      # resource path
    ...
    # @param korona_account_id [String] account id of the KORONA.cloud account
    # @param body [Array<ItemSequence>] array of existing item sequences (id or number required)
    # @param [Hash] opts the optional parameters
    # @return [Array<AddOrUpdateResult>]
    def delete_item_sequences(korona_account_id, body, opts = {})
      data, _status_code, _headers = delete_item_sequences_with_http_info(korona_account_id, body, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<AddOrUpdateResult>, Integer, Hash)>] Array<AddOrUpdateResult> data, response status code and response headers
    def delete_item_sequences_with_http_info(korona_account_id, body, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ItemSequencesApi.delete_item_sequences"
      end
      # resource path
      local_var_path = '/accounts/{koronaAccountId}/itemSequences'.sub('{' + 'koronaAccountId' + '}', CGI.escape(korona_account_id.to_s))
    ...
    # @param korona_account_id [String] account id of the KORONA.cloud account
    # @param item_sequence_id [String] id of the related object (important: id should match the uuid-format)
    # @param body [ItemSequence] the properties to update of the item sequence
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def update_item_sequence(korona_account_id, item_sequence_id, body, opts = {})
      update_item_sequence_with_http_info(korona_account_id, item_sequence_id, body, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def update_item_sequence_with_http_info(korona_account_id, item_sequence_id, body, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ItemSequencesApi.update_item_sequence"
      end
      # resource path
      local_var_path = '/accounts/{koronaAccountId}/itemSequences/{itemSequenceId}'.sub('{' + 'koronaAccountId' + '}', CGI.escape(korona_account_id.to_s)).sub('{' + 'itemSequenceId' + '}', CGI.escape(item_sequence_id.to_s))
    ...
    # @param korona_account_id [String] account id of the KORONA.cloud account
    # @param body [Array<ItemSequence>] an array of existing item sequences
    # @param [Hash] opts the optional parameters
    # @return [Array<AddOrUpdateResult>]
    def update_item_sequences(korona_account_id, body, opts = {})
      data, _status_code, _headers = update_item_sequences_with_http_info(korona_account_id, body, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<AddOrUpdateResult>, Integer, Hash)>] Array<AddOrUpdateResult> data, response status code and response headers
    def update_item_sequences_with_http_info(korona_account_id, body, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ItemSequencesApi.update_item_sequences"
      end
      # resource path
      local_var_path = '/accounts/{koronaAccountId}/itemSequences'.sub('{' + 'koronaAccountId' + '}', CGI.escape(korona_account_id.to_s))
