...
module KoronaCloudClient
  class ExternalSystemCallsApi
    ...
    # @param body [Array<ExternalSystemCall>] array of new external system calls
    ...
    # @param korona_account_id [String] account id of the KORONA.cloud account
    # @param body [Array<ExternalSystemCall>] array of existing external system calls (id or number required)
    # @param [Hash] opts the optional parameters
    # @return [Array<AddOrUpdateResult>]
    ...
    # @param korona_account_id [String] account id of the KORONA.cloud account
    # @param external_system_call_id [String] id of the related object (important: id should match the uuid-format)
    # @param body [ExternalSystemCall] the properties to update of the external system call
    # @param [Hash] opts the optional parameters
    # @return [nil]
