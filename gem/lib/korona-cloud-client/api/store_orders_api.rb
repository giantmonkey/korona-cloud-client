...
module KoronaCloudClient
  class StoreOrdersApi
    ...
    # @return [nil]
    def order_store_order(korona_account_id, store_order_id, opts = {})
      order_store_order_with_http_info(korona_account_id, store_order_id, opts)
      nil
    end
    ...
    # @option opts [String] :supplier supplier
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def order_store_order_with_http_info(korona_account_id, store_order_id, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && opts[:'order_action'] && !allowable_values.include?(opts[:'order_action'])
      ...
      # query parameters
      query_params = opts[:query_params] || {}
      query_params[:'orderAction'] = opts[:'order_action'] if !opts[:'order_action'].nil?
