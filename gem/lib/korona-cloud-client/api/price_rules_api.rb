...
module KoronaCloudClient
  class PriceRulesApi
    ...
    # @param body [Array<PriceRule>] array of new price rules
    # @param [Hash] opts the optional parameters
    # @option opts [Boolean] :upsert when set to true, updates the object instead of generating a already-exists-error
    # @return [Array<AddOrUpdateResult>]
    def add_price_rules(korona_account_id, body, opts = {})
      data, _status_code, _headers = add_price_rules_with_http_info(korona_account_id, body, opts)
      data
    end
    ...
    def add_price_rules_with_http_info(korona_account_id, body, opts = {})
      ...
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling PriceRulesApi.add_price_rules"
      end
      # resource path
    ...
    # @param korona_account_id [String] account id of the KORONA.cloud account
    # @param body [Array<PriceRule>] array of existing price rules (id or number required)
    # @param [Hash] opts the optional parameters
    # @return [Array<AddOrUpdateResult>]
    def delete_price_rules(korona_account_id, body, opts = {})
      data, _status_code, _headers = delete_price_rules_with_http_info(korona_account_id, body, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<AddOrUpdateResult>, Integer, Hash)>] Array<AddOrUpdateResult> data, response status code and response headers
    def delete_price_rules_with_http_info(korona_account_id, body, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling PriceRulesApi.delete_price_rules"
      end
      # resource path
      local_var_path = '/accounts/{koronaAccountId}/priceRules'.sub('{' + 'koronaAccountId' + '}', CGI.escape(korona_account_id.to_s))
    ...
    # @param korona_account_id [String] account id of the KORONA.cloud account
    # @param price_rule_id [String] id of the related object (important: id should match the uuid-format)
    # @param body [PriceRule] the properties to update of the price rule
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def update_price_rule(korona_account_id, price_rule_id, body, opts = {})
      update_price_rule_with_http_info(korona_account_id, price_rule_id, body, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def update_price_rule_with_http_info(korona_account_id, price_rule_id, body, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling PriceRulesApi.update_price_rule"
      end
      # resource path
      local_var_path = '/accounts/{koronaAccountId}/priceRules/{priceRuleId}'.sub('{' + 'koronaAccountId' + '}', CGI.escape(korona_account_id.to_s)).sub('{' + 'priceRuleId' + '}', CGI.escape(price_rule_id.to_s))
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<AddOrUpdateResult>]
    def update_price_rules(korona_account_id, body, opts = {})
      data, _status_code, _headers = update_price_rules_with_http_info(korona_account_id, body, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Array<AddOrUpdateResult>, Integer, Hash)>] Array<AddOrUpdateResult> data, response status code and response headers
    def update_price_rules_with_http_info(korona_account_id, body, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling PriceRulesApi.update_price_rules"
      end
      # resource path
      local_var_path = '/accounts/{koronaAccountId}/priceRules'.sub('{' + 'koronaAccountId' + '}', CGI.escape(korona_account_id.to_s))
